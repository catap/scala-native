// ###sourceLocation(file: "/Users/catap/src/scala-native/nativelib/src/main/scala/scala/scalanative/runtime/CAtomics.scala.gyb", line: 1)
...
// ###sourceLocation(file: "/Users/catap/src/scala-native/nativelib/src/main/scala/scala/scalanative/runtime/CAtomics.scala.gyb", line: 27)

// ###sourceLocation(file: "/Users/catap/src/scala-native/nativelib/src/main/scala/scala/scalanative/runtime/CAtomics.scala.gyb", line: 29)

// ###sourceLocation(file: "/Users/catap/src/scala-native/nativelib/src/main/scala/scala/scalanative/runtime/CAtomics.scala.gyb", line: 33)
...
class CAtomicUnsignedShort(
  ...
  private[this] val atm =
    fromRawPtr[CUnsignedShort](libc.malloc(sizeof[CUnsignedShort]))
  ...
  def compareAndSwapStrong(
    ...
    val expectedPtr =
      fromRawPtr[CUnsignedShort](Intrinsics.stackalloc(sizeof[CUnsignedShort]))
    !expectedPtr = expected
...
class CAtomicUnsignedInt(default: CUnsignedInt = 0.asInstanceOf[CUnsignedInt])
  ...
  private[this] val atm =
    fromRawPtr[CUnsignedInt](libc.malloc(sizeof[CUnsignedInt]))
  ...
  def compareAndSwapStrong(expected: CUnsignedInt,
    ...
    val expectedPtr =
      fromRawPtr[CUnsignedInt](Intrinsics.stackalloc(sizeof[CUnsignedInt]))
    !expectedPtr = expected
...
class CAtomicUnsignedLong(
  ...
  private[this] val atm =
    fromRawPtr[CUnsignedLong](libc.malloc(sizeof[CUnsignedLong]))
  ...
  def compareAndSwapStrong(expected: CUnsignedLong,
    ...
    val expectedPtr =
      fromRawPtr[CUnsignedLong](Intrinsics.stackalloc(sizeof[CUnsignedLong]))
    !expectedPtr = expected
...
class CAtomicUnsignedChar(
  ...
  private[this] val atm =
    fromRawPtr[CUnsignedChar](libc.malloc(sizeof[CUnsignedChar]))
  ...
  def compareAndSwapStrong(expected: CUnsignedChar,
    ...
    val expectedPtr =
      fromRawPtr[CUnsignedChar](Intrinsics.stackalloc(sizeof[CUnsignedChar]))
    !expectedPtr = expected
...
// ###sourceLocation(file: "/Users/catap/src/scala-native/nativelib/src/main/scala/scala/scalanative/runtime/CAtomics.scala.gyb", line: 121)
...
// ###sourceLocation(file: "/Users/catap/src/scala-native/nativelib/src/main/scala/scala/scalanative/runtime/CAtomics.scala.gyb", line: 140)
...
// ###sourceLocation(file: "/Users/catap/src/scala-native/nativelib/src/main/scala/scala/scalanative/runtime/CAtomics.scala.gyb", line: 142)
